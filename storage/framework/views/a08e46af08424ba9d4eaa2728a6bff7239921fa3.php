    ...
    <div class="container">
                ...
                <div class="col-6 col-md-3">
                    <?php if(!empty($footerColumns[$column])): ?>
                        <?php if(!empty($footerColumns[$column]['title'])): ?>
                            <span class="header d-block text-white font-weight-bold fs-4 p-1" ><?php echo e($footerColumns[$column]['title']); ?></span>
                        <?php endif; ?>
        ...
        <div class="mt-40 border-blue py-25 d-flex align-items-center justify-content-between">
            ...
            <p class="text-white m-0">
                &copy; <?php echo e(date('Y')); ?> <?php echo e($generalSettings['site_name'] ?? ''); ?>
...
<?php /**PATH D:\project\gazacademy\resources\views/web/default/includes/footer.blade.php ENDPATH**/ ?>