            ...
            <div class="container user-select-none">
                ...
                <?php else: ?>
                    <div class="text-center slider-content">
                        ...
                        <?php
                            $parts = explode(',', $heroSectionData['title']);
                        ?>

                        <h1 style="font-size: 60px"><?php echo e($parts[0]); ?>


                            <?php if(isset($parts[1])): ?>
                                <span style="font-size: 40px; margin-top: 0;">,<?php echo e($parts[1]); ?></span>
                            <?php endif; ?>
                        </h1>

                        <div class="row sub-title h-100 align-items-center justify-content-center text-center">
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\gazacademy\resources\views/web/default/pages/home.blade.php ENDPATH**/ ?>