    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_settings')): ?>
                ...
                <li>
                    <a class="nav-link" href="<?php echo e(getAdminPanelUrl()); ?>/translation">
                        <i class="fas fa-solid fa-language"></i>
                        <span><?php echo e(trans('admin/main.translation')); ?></span>
                    </a>
                </li>
            <?php endif; ?>
...
<?php /**PATH D:\project\gazacademy\resources\views/admin/includes/sidebar.blade.php ENDPATH**/ ?>