...
<div class="dropdown" style="width: 60px !important">
    <button type="button" class="btn btn-transparent dropdown-toggle" style="<?php echo e($isRtl ? 'padding-right: 0 !important; padding-left: 20px !important' : 'padding-left: 0 !important'); ?>" <?php echo e((empty($unReadNotifications) or count($unReadNotifications) < 1) ? 'disabled' : ''); ?> id="navbarNotification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="dropdown-menu pt-20" aria-labelledby="navbarNotification">
        <div class="d-flex flex-column h-100">
            <div class="mb-auto navbar-notification-card" data-simplebar style="width: 100% !important">
...
<?php /**PATH D:\project\gazacademy\resources\views/web/default/includes/notification-dropdown.blade.php ENDPATH**/ ?>