...
[dir='rtl'] .m-top-bar .toooltip-click-content .currenies, .m-top-bar .toooltip-content .currenies {
        ...
        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    ...
                    <span class="course-count-badge py-5 px-10 text-white rounded font-15"><?php echo e($coursesCount); ?> <?php echo e(trans('product.courses')); ?></span>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\gazacademy\resources\views/web/default/pages/classes.blade.php ENDPATH**/ ?>