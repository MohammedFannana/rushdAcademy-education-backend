                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex align-items-center wizard-custom-radio mt-5">
                                    <div class="wizard-custom-radio-item flex-grow-1">
                                        <input type="radio" name="account_type" value="teacher" id="role_teacher" class=""
                                            checked>
                                        <label class="font-12 cursor-pointer px-15 py-10"
                                            for="role_teacher"><?php echo e(trans('update.role_teacher')); ?></label>
                                    </div>
                                    <?php
                                        $selectRolesDuringRegistration = array_filter($selectRolesDuringRegistration, function ($role) {
                                            return $role !== 'teacher';
                                        });
                                    ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="timezone" class="form-control select2" data-allow-clear="false">
                                                    ...
                                                    <?php $__currentLoopData = getListOfTimezones(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timezone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($timezone); ?>" <?php if($selectedTimezone == $timezone): ?> selected <?php endif; ?>>
...
<?php echo $__env->make(getTemplate() . '.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\gazacademy\resources\views/web/default/auth/register.blade.php ENDPATH**/ ?>