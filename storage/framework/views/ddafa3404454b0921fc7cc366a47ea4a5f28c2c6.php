    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
            ...
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">Gaza Academy</h1>
                <h5 class="font-weight-normal text-muted-transparent">Educational platform for Gaza youth</h5>
              </div>
              All rights reserved <a class="text-light bb" target="_blank" href="https://codecanyon.net/user/rocketsoft"></a>  <a class="text-light bb" target="_blank" href="https://codecanyon.net/collections/10821267-rocket-lms-full-package"></a>
            </div>
          </div>
            </div>
...
<?php /**PATH D:\project\gazacademy\resources\views/admin/auth/auth_layout.blade.php ENDPATH**/ ?>