    ...
    <section class="">
        ...
        <div class="bg-white dashboard-banner-container position-relative px-15 px-ld-35 py-10 panel-shadow rounded-sm">
            ...
            <div class="dashboard-banner">
                <img src="<?php echo e(getPageBackgroundSettings('dashboard')); ?>" alt="" class="img-cover" id="img-banner">
            </div>
        </div>
    </section>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\gazacademy\resources\views/web/default/panel/dashboard/index.blade.php ENDPATH**/ ?>