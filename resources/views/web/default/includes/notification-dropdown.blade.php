...
<div class="dropdown" style="width: 60px !important">
    <button type="button" class="btn btn-transparent dropdown-toggle" style="{{ $isRtl ? 'padding-right: 0 !important; padding-left: 20px !important' : 'padding-left: 0 !important' }}" {{ (empty($unReadNotifications) or count($unReadNotifications) < 1) ? 'disabled' : '' }} id="navbarNotification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
