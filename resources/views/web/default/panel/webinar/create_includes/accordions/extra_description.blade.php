                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        @else
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="Learning_materials_title" name="ajax[{{ !empty($extraDescription) ? $extraDescription->id : 'new' }}][value]" class="js-ajax-value form-control" value="{{ !empty($extraDescription) ? $extraDescription->value : '' }}"/>
                                <div class="invalid-feedback"></div>
                            </div>
                        @endif
                    </div>
