    ...
    <div class="col-12 col-md-4 mt-15">
        ...
        @if(!empty(getGeneralSettings('content_translate')))
            <div class="form-group">
                ...
                <select id="locale" name="locale" class="custom-select {{ !empty($webinar) ? 'js-edit-content-locale' : '' }}">
        ...
        <div class="form-group mt-15 ">
            ...
            <select id="course_type" name="type" class="custom-select @error('type')  is-invalid @enderror">
        ...
        <div class="form-group mt-15">
            ...
            <input type="text" id="title" name="title" value="{{ (!empty($webinar) and !empty($webinar->translate($locale))) ? $webinar->translate($locale)->title : old('title') }}" class="form-control @error('title')  is-invalid @enderror" placeholder=""/>
            @error('title')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="form-group mt-15">
            ...
            <input type="text" id="seo_description" name="seo_description" value="{{ (!empty($webinar) and !empty($webinar->translate($locale))) ? $webinar->translate($locale)->seo_description : old('seo_description') }}" class="form-control @error('seo_description')  is-invalid @enderror " placeholder="{{ trans('forms.50_160_characters_preferred') }}"/>
...
$.ajax({
    ...
    data: {
        ...
        title: $('#title').val(),
        description: typeof $('#summernote').summernote === 'function'
