            ...
            <div class="list">
                ...
                <div class="nav-dropdown level-1">
                    ...
                    <ul class="subnav">
                        ...
                        <li class="nav-item">
                            <a href="#" class="sub-button"><span class="{{$sidebar[$i]['child'][$j]['icon']}} icons"></span><span>{{$sidebar[$i]['child'][$j]['label']}}</span> @if(!empty($sidebar[$i]['child'][$j]['child']))<span class="right-arrow"><i class="far fa-chevron-right"></i></span>@endif</a>
            ...
            <div class="list">
                ...
                <div class="nav-dropdown level-1">
                    ...
                    <ul class="subnav">
                        ...
                        <li class="nav-item">
                            <a href="#" class="sub-button"><span class="{{$level1['icon']}} icons"></span><span>{{$level1['label']}}</span> @if(!empty($level1['child']))<span class="right-arrow"><i class="far fa-chevron-right"></i></span>@endif</a>
