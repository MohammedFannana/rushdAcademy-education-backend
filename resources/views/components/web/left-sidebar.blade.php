                    ...
                    <div class="q-drawer__content fit scroll">
                        ...
                        <div class="bg-[#B92025] p-2" style="padding-top: 50px !important">
                                        ...
                                        <div class="container mb-1 p-1 d-flex justify-content-center" style="display: flex !important;
                                            ...
                                            flex-direction: column;">
                                                                                        ...
                                                                                        <span class="fw-bold" style="font-size: 18px;">{{ Auth::user()->full_name }}</span>


                                            <a href="https://kemecademy.com/logout" class="btn btn-sm btn-warning fw-bold" style="background-color: #ffc50b !important">{{ __('admin/main.logout') }}</a>
                                        </div>
                                    </div>
                        ...
                        <!-- <div>
                                    <div
                                        ...
                                        <div class="ml-5">
                                            <div class="font-14 font-weight-bold text-secondary">{{ Auth::user()->full_name }}
                                            </div>
                                            <span class="mmt-5 text-gray font-12">{{ Auth::user()->role_name }}</span>
                                        </div>
                                    </div> -->
                                    ...
                                    <!-- <div class="relative">
                                                <div class="container mb-1 p-1 d-flex justify-content-center"
                                                    ...
                                                    <span class="fw-bold">{{ Auth::user()->role_name }}</span>
                                                </div>
                                            </div> -->
                        ...
                        <div class=" p-2 mobileSystem" style="padding-top: 40px !important; height:100vh ;background-color: #B92025;width:100%">
                            <div class="q-gutter mt-3 row flex-column" style="--bs-gutter-x: -0.5rem; margin-top : 8px">
                                ...
                                <a class="w-100 ms-0 q-btn q-btn-item non-selectable no-outline q-btn--standard q-btn--rectangle q-btn--actionable q-focusable q-hoverable col text-black bg-[#FFC50B]"
                                    tabindex="0"
                                    href="{{returnSSOLinkWithLang('login')}}"
                                    ...
                                    @for ($i = 0; $i < count($dropdownsidebar); $i++)
                                        <li class="dpdw-link">
                                            <a class="dropdown-item {{ $dropdownsidebar[$i]['label'] == $route ? 'active' : '' }}"
                                                href="{{ $dropdownsidebar[$i]['link'] }}">
                                                {{ $dropdownsidebar[$i]['label'] }}</a>
                                        </li>
                                    @endfor
                                </ul>
                            </div>
                    ...
                    <div class="relative">
                        @if (isset($sidebar))
                            ...
                            @for ($i = 0; $i < count($sidebar); $i++)
                                {{-- <div class="q-item q-item-type row no-wrap parent" style="--bs-gutter-x: 0.5rem;"
                                    role="listitem">
                                    <div
                                        class="mainText q-item__section column q-item__section--main justify-center bg-[#FFC50B] py-[5px] px-[10px] rounded-md d-flex flex-row justify-between">
                                        <div>
                                        ...
                                        @if (!empty($sidebar[$i]['child']))
                                            <div
                                                ...
                                                <button class="btn btn-toggle align-items-center rounded" data-bs-toggle="collapse"
                                                    data-bs-target="#home-collapse-{{ $sidebar[$i]['id'] }}" aria-expanded="false">
                                    ...
                                    <div class="q-expansion-item__container relative-position">
                                        ...
                                        @if (!empty($sidebar[$i]['child']))
                                            <div class="collapse relative-position {{ $i == 0 ? 'show' : '' }}"
                                                style="margin-left: 10px" id="home-collapse-{{ $sidebar[$i]['id'] }}">

                                                @for ($j = 0; $j < count($sidebar[$i]['child']); $j++)
                                                  @auth
                                                                                                            @if ($sidebar[$i]['id'] === 5740)
                                                                                                                            ...
                                                                                                                            <ul id="panel-sidebar-scroll" style="padding: 0 !important;"
                                                                                                                                ...
                                                                                                                                <li
                                                                                                                                    class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                ...
                                                                                                                                @if($authUser->isOrganization())
                                                                                                                                    <li
                                                                                                                                        class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/instructors') or request()->is('panel/manage/instructors*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                        ...
                                                                                                                                        <div class="collapse {{ (request()->is('panel/instructors') or request()->is('panel/manage/instructors*')) ? 'show' : '' }}"
                                                                                                                                            ...
                                                                                                                                            <ul class="sidenav-item-collapse">
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/instructors/new')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/manage/instructors/new">{{ trans('public.new') }}</a>
                                                                                                                                                </li>
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/manage/instructors')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/manage/instructors">{{ trans('public.list') }}</a>
                                                                                                                                                </li>
                                                                                                                                            </ul>
                                                                                                                                        </div>
                                                                                                                                    </li>
                                                                                                                                    ...
                                                                                                                                    <li
                                                                                                                                        class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/students') or request()->is('panel/manage/students*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                        <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                        ...
                                                                                                                                        <div class="collapse {{ (request()->is('panel/students') or request()->is('panel/manage/students*')) ? 'show' : '' }}"
                                                                                                                                            ...
                                                                                                                                            <ul class="sidenav-item-collapse">
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/manage/students/new')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/manage/students/new">{{ trans('public.new') }}</a>
                                                                                                                                                </li>
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/manage/students')) ? 'active' : '' }}">
                                                                                                                                ...
                                                                                                                                <!-- -->
                                                                                                                                <li
                                                                                                                                    class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/webinars') or request()->is('panel/webinars/*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                    <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                        ...
                                                                                                                                        <span>{{ trans('panel.webinars') }}</span>
                                                                                                                                    ...
                                                                                                                                    <div class="collapse {{ (request()->is('panel/webinars') or request()->is('panel/webinars/*')) ? 'show' : '' }}"
                                                                                                                                        ...
                                                                                                                                        <ul class="sidenav-item-collapse">
                                                                                                                                            @if($authUser->isOrganization() || $authUser->isTeacher())
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/webinars/new')) ? 'active' : '' }}">
                                                                                                                                                    <a href="/panel/webinars/new">{{ trans('public.new') }}</a>
                                                                                                                                                </li>

                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/webinars')) ? 'active' : '' }}">
                                                                                                                                                    <a href="/panel/webinars">{{ trans('panel.my_classes') }}</a>
                                                                                                                                                </li>

                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/webinars/invitations')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/webinars/invitations">{{ trans('panel.invited_classes') }}</a>
                                                                                                                                                </li>
                                                                                                                                            @endif

                                                                                                                                            @if(!empty($authUser->organ_id))
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/webinars/organization_classes')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                            ...
                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/webinars/purchases')) ? 'active' : '' }}">
                                                                                                                                                <a
                                                                                                                                                    href="/panel/webinars/purchases">{{ trans('panel.my_purchases') }}</a>
                                                                                                                                            </li>

                                                                                                                                            @if($authUser->isOrganization() || $authUser->isTeacher())
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/webinars/comments')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/webinars/comments">{{ trans('panel.my_class_comments') }}</a>
                                                                                                                                                </li>
                                                                                                                                            @endif

                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/webinars/my-comments')) ? 'active' : '' }}">
                                                                                                                                                <a
                                                                                                                                                    href="/panel/webinars/my-comments">{{ trans('panel.my_comments') }}</a>
                                                                                                                                            </li>

                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/webinars/favorites')) ? 'active' : '' }}">
                                                                                                                                                <a
                                                                                                                                                    href="/panel/webinars/favorites">{{ trans('panel.favorites') }}</a>
                                                                                                                                            </li>
                                                                                                                                        </ul>
                                                                                                                                    </div>
                                                                                                                                </li>
                                                                                                                                ...
                                                                                                                                @if(!empty(getFeaturesSettings('upcoming_courses_status')))
                                                                                                                                    <li
                                                                                                                                        class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/upcoming_courses') or request()->is('panel/upcoming_courses/*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                        <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                        ...
                                                                                                                                        <div class="collapse {{ (request()->is('panel/upcoming_courses') or request()->is('panel/upcoming_courses/*')) ? 'show' : '' }}"
                                                                                                                                            ...
                                                                                                                                            <ul class="sidenav-item-collapse">
                                                                                                                                                @if($authUser->isOrganization() || $authUser->isTeacher())
                                                                                                                                                    <li
                                                                                                                                                        class="mmt-5 {{ (request()->is('panel/upcoming_courses/new')) ? 'active' : '' }}">
                                                                                                                                                        <a
                                                                                                                                                            href="/panel/upcoming_courses/new">{{ trans('public.new') }}</a>
                                                                                                                                                    </li>

                                                                                                                                                    <li
                                                                                                                                                        class="mmt-5 {{ (request()->is('panel/upcoming_courses')) ? 'active' : '' }}">
                                                                                                                                                        <a
                                                                                                                                                            href="/panel/upcoming_courses">{{ trans('update.my_upcoming_courses') }}</a>
                                                                                                                                                    </li>
                                                                                                                                                @endif

                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/upcoming_courses/followings')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/upcoming_courses/followings">{{ trans('update.following_courses') }}</a>
                                                                                                                                                </li>
                                                                                                                                            </ul>
                                                                                                                                        </div>
                                                                                                                                    </li>
                                                                                                                                ...
                                                                                                                                @if($authUser->isOrganization() or $authUser->isTeacher())
                                                                                                                                    <li
                                                                                                                                        class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/bundles') or request()->is('panel/bundles/*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                        <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                        ...
                                                                                                                                        <div class="collapse {{ (request()->is('panel/bundles') or request()->is('panel/bundles/*')) ? 'show' : '' }}"
                                                                                                                                            ...
                                                                                                                                            <ul class="sidenav-item-collapse">
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/bundles/new')) ? 'active' : '' }}">
                                                                                                                                                    <a href="/panel/bundles/new">{{ trans('public.new') }}</a>
                                                                                                                                                </li>

                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/bundles')) ? 'active' : '' }}">
                                                                                                                                ...
                                                                                                                                @if(getFeaturesSettings('webinar_assignment_status'))
                                                                                                                                    <li
                                                                                                                                        class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/assignments') or request()->is('panel/assignments/*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                        <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                        ...
                                                                                                                                        <div class="collapse {{ (request()->is('panel/assignments') or request()->is('panel/assignments/*')) ? 'show' : '' }}"
                                                                                                                                            ...
                                                                                                                                            <ul class="sidenav-item-collapse">
                                                                                                                                                ...
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/assignments/my-assignments')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/assignments/my-assignments">{{ trans('update.my_assignments') }}</a>
                                                                                                                                                </li>

                                                                                                                                                @if($authUser->isOrganization() || $authUser->isTeacher())
                                                                                                                                                    <li
                                                                                                                                                        class="mmt-5 {{ (request()->is('panel/assignments/my-courses-assignments')) ? 'active' : '' }}">
                                                                                                                                                        <a
                                                                                                                                ...
                                                                                                                                <li
                                                                                                                                    class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/meetings') or request()->is('panel/meetings/*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                    <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                        ...
                                                                                                                                        <span>{{ trans('panel.meetings') }}</span>
                                                                                                                                        <button class="btn btn-toggle align-items-center rounded collapsed" id="mainbtn"
                                                                                                                                            data-bs-toggle="collapse" data-bs-target="#home-collapse-child-5592"
                                                                                                                                            aria-expanded="false">
                                                                                                                                            <svg class="svg-inline--fa fa-caret-down fa-w-10" aria-hidden="true"
                                                                                                                                    ...
                                                                                                                                    <div class="collapse {{ (request()->is('panel/meetings') or request()->is('panel/meetings/*')) ? 'show' : '' }}"
                                                                                                                                        ...
                                                                                                                                        <ul class="sidenav-item-collapse">
                                                                                                                                            ...
                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/meetings/reservation')) ? 'active' : '' }}">
                                                                                                                                                <a
                                                                                                                                                    href="/panel/meetings/reservation">{{ trans('public.my_reservation') }}</a>
                                                                                                                                            </li>

                                                                                                                                            @if($authUser->isOrganization() || $authUser->isTeacher())
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/meetings/requests')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/meetings/requests">{{ trans('panel.requests') }}</a>
                                                                                                                                                </li>

                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/meetings/settings')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/meetings/settings">{{ trans('panel.settings') }}</a>
                                                                                                                                                </li>
                                                                                                                                            @endif
                                                                                                                                        </ul>
                                                                                                                                    </div>
                                                                                                                                ...
                                                                                                                                <li
                                                                                                                                    class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/quizzes') or request()->is('panel/quizzes/*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                    <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                    ...
                                                                                                                                    <div class="collapse {{ (request()->is('panel/quizzes') or request()->is('panel/quizzes/*')) ? 'show' : '' }}"
                                                                                                                                        ...
                                                                                                                                        <ul class="sidenav-item-collapse">
                                                                                                                                            @if($authUser->isOrganization() || $authUser->isTeacher())
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/quizzes/new')) ? 'active' : '' }}">
                                                                                                                                                    <a href="/panel/quizzes/new">{{ trans('quiz.new_quiz') }}</a>
                                                                                                                                                </li>
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/quizzes')) ? 'active' : '' }}">
                                                                                                                                                    <a href="/panel/quizzes">{{ trans('public.list') }}</a>
                                                                                                                                                </li>
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/quizzes/results')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/quizzes/results">{{ trans('public.results') }}</a>
                                                                                                                                                </li>
                                                                                                                                            @endif

                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/quizzes/my-results')) ? 'active' : '' }}">
                                                                                                                                                <a
                                                                                                                                                    href="/panel/quizzes/my-results">{{ trans('public.my_results') }}</a>
                                                                                                                                            </li>

                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/quizzes/opens')) ? 'active' : '' }}">
                                                                                                                                                <a
                                                                                                                                                    href="/panel/quizzes/opens">{{ trans('public.not_participated') }}</a>
                                                                                                                                            </li>
                                                                                                                                        </ul>
                                                                                                                                    </div>
                                                                                                                                </li>
                                                                                                                                ...
                                                                                                                                <li
                                                                                                                                    class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/certificates') or request()->is('panel/certificates/*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                    <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                    ...
                                                                                                                                    <div class="collapse {{ (request()->is('panel/certificates') or request()->is('panel/certificates/*')) ? 'show' : '' }}"
                                                                                                                                        ...
                                                                                                                                        <ul class="sidenav-item-collapse">
                                                                                                                                            @if($authUser->isOrganization() || $authUser->isTeacher())
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/certificates')) ? 'active' : '' }}">
                                                                                                                                                    <a href="/panel/certificates">{{ trans('public.list') }}</a>
                                                                                                                                                </li>
                                                                                                                                            @endif

                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/certificates/achievements')) ? 'active' : '' }}">
                                                                                                                                                <a
                                                                                                                                                    href="/panel/certificates/achievements">{{ trans('quiz.achievements') }}</a>
                                                                                                                                            </li>

                                                                                                                                            <li class="mmt-5">
                                                                                                                                                <a
                                                                                                                                                    href="/certificate_validation">{{ trans('site.certificate_validation') }}</a>
                                                                                                                                            </li>

                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/certificates/webinars')) ? 'active' : '' }}">
                                                                                                                                                <a
                                                                                                                                                    href="/panel/certificates/webinars">{{ trans('update.course_certificates') }}</a>
                                                                                                                                            </li>
                                                                                                                                ...
                                                                                                                                @if($authUser->checkCanAccessToStore())
                                                                                                                                            <li
                                                                                                                                                class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/store') or request()->is('panel/store/*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                                <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                            ...
                                                                                                                                            <svg class="svg-inline--fa fa-caret-down fa-w-10" aria-hidden="true"
                                                                                                                                                ...
                                                                                                                                                <div class="collapse {{ (request()->is('panel/store') or request()->is('panel/store/*')) ? 'show' : '' }}"
                                                                                                                                                    ...
                                                                                                                                                    <ul class="sidenav-item-collapse">
                                                                                                                                                        @if($authUser->isOrganization() || $authUser->isTeacher())
                                                                                                                                                                                <li
                                                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/store/products/new')) ? 'active' : '' }}">
                                                                                                                                                                                    <a
                                                                                                                                                                                        href="/panel/store/products/new">{{ trans('update.new_product') }}</a>
                                                                                                                                                                                </li>

                                                                                                                                                                                <li
                                                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/store/products')) ? 'active' : '' }}">
                                                                                                                                                                                    <a
                                                                                                                                                                                        href="/panel/store/products">{{ trans('update.products') }}</a>
                                                                                                                                                                                </li>
                                                                                                                                                                                ...
                                                                                                                                                                                <li
                                                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/store/sales')) ? 'active' : '' }}">
                                                                                                                                                        ...
                                                                                                                                                        <li
                                                                                                                                                            class="mmt-5 {{ (request()->is('panel/store/purchases')) ? 'active' : '' }}">
                                                                                                                                                            <a
                                                                                                                                                                href="/panel/store/purchases">{{ trans('panel.my_purchases') }}</a>
                                                                                                                                                        </li>

                                                                                                                                                        @if($authUser->isOrganization() || $authUser->isTeacher())
                                                                                                                                                            <li
                                                                                                                                                                class="mmt-5 {{ (request()->is('panel/store/products/comments')) ? 'active' : '' }}">
                                                                                                                                                                <a
                                                                                                                                                                    href="/panel/store/products/comments">{{ trans('update.product_comments') }}</a>
                                                                                                                                                            </li>
                                                                                                                                                        @endif

                                                                                                                                                        <li
                                                                                                                                                            class="mmt-5 {{ (request()->is('panel/store/products/my-comments')) ? 'active' : '' }}">
                                                                                                                                                            <a
                                                                                                                                                                href="/panel/store/products/my-comments">{{ trans('panel.my_comments') }}</a>
                                                                                                                                                        </li>
                                                                                                                                                    </ul>
                                                                                                                                                </div>
                                                                                                                                            </li>
                                                                                                                                ...
                                                                                                                                <li
                                                                                                                                    class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/financial') or request()->is('panel/financial/*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                    <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                        ...
                                                                                                                                        <span>{{ trans('panel.financial') }}</span>
                                                                                                                                        <button class="btn btn-toggle align-items-center rounded collapsed" id="mainbtn"
                                                                                                                                            data-bs-toggle="collapse" data-bs-target="#home-collapse-child-5592"
                                                                                                                                            aria-expanded="false">
                                                                                                                                            <svg class="svg-inline--fa fa-caret-down fa-w-10" aria-hidden="true"
                                                                                                                                    ...
                                                                                                                                    <div class="collapse {{ (request()->is('panel/financial') or request()->is('panel/financial/*')) ? 'show' : '' }}"
                                                                                                                                        ...
                                                                                                                                        <ul class="sidenav-item-collapse">
                                                                                                                                            ...
                                                                                                                                            @if($authUser->isOrganization() || $authUser->isTeacher())
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/financial/sales')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/financial/sales">{{ trans('financial.sales_report') }}</a>
                                                                                                                                                </li>
                                                                                                                                            @endif

                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/financial/summary')) ? 'active' : '' }}">
                                                                                                                                                <a
                                                                                                                                                    href="/panel/financial/summary">{{ trans('financial.financial_summary') }}</a>
                                                                                                                                            </li>

                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/financial/payout')) ? 'active' : '' }}">
                                                                                                                                                <a
                                                                                                                                                    href="/panel/financial/payout">{{ trans('financial.payout') }}</a>
                                                                                                                                            </li>

                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/financial/account')) ? 'active' : '' }}">
                                                                                                                                                <a
                                                                                                                                                    href="/panel/financial/account">{{ trans('financial.charge_account') }}</a>
                                                                                                                                            </li>

                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/financial/subscribes')) ? 'active' : '' }}">
                                                                                                                                                <a
                                                                                                                                                    href="/panel/financial/subscribes">{{ trans('financial.subscribes') }}</a>
                                                                                                                                            </li>

                                                                                                                                            @if(($authUser->isOrganization() || $authUser->isTeacher()) and getRegistrationPackagesGeneralSettings('status'))
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/financial/registration-packages')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                            ...
                                                                                                                                            @if(getInstallmentsSettings('status'))
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/financial/installments*')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/financial/installments">{{ trans('update.installments') }}</a>
                                                                                                                                                </li>
                                                                                                                                            @endif
                                                                                                                                        </ul>
                                                                                                                                    </div>
                                                                                                                                ...
                                                                                                                                <li
                                                                                                                                    class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/support') or request()->is('panel/support/*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                    <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                    ...
                                                                                                                                    <div class="collapse {{ (request()->is('panel/support') or request()->is('panel/support/*')) ? 'show' : '' }}"
                                                                                                                                        ...
                                                                                                                                        <ul class="sidenav-item-collapse">
                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/support/new')) ? 'active' : '' }}">
                                                                                                                                                <a href="/panel/support/new">{{ trans('public.new') }}</a>
                                                                                                                                            </li>
                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/support')) ? 'active' : '' }}">
                                                                                                                                                <a
                                                                                                                                                    href="/panel/support">{{ trans('panel.classes_support') }}</a>
                                                                                                                                            </li>
                                                                                                                                            <li
                                                                                                                                                class="mmt-5 {{ (request()->is('panel/support/tickets')) ? 'active' : '' }}">
                                                                                                                                                <a
                                                                                                                                                    href="/panel/support/tickets">{{ trans('panel.support_tickets') }}</a>
                                                                                                                                            </li>
                                                                                                                                        </ul>
                                                                                                                                    </div>
                                                                                                                                </li>
                                                                                                                                ...
                                                                                                                                @if(!$authUser->isUser() or (!empty($referralSettings) and $referralSettings['status'] and $authUser->affiliate) or (!empty(getRegistrationBonusSettings('status')) and $authUser->enable_registration_bonus))
                                                                                                                                    <li
                                                                                                                                        class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/marketing') or request()->is('panel/marketing/*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                        <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                            ...
                                                                                                                                            <span>{{ trans('panel.marketing') }}</span>
                                                                                                                                            <button class="btn btn-toggle align-items-center rounded collapsed" id="mainbtn"
                                                                                                                                            data-bs-toggle="collapse" data-bs-target="#home-collapse-child-5592"
                                                                                                                                            aria-expanded="false">
                                                                                                                                            <svg class="svg-inline--fa fa-caret-down fa-w-10" aria-hidden="true"
                                                                                                                                        ...
                                                                                                                                        <div class="collapse {{ (request()->is('panel/marketing') or request()->is('panel/marketing/*')) ? 'show' : '' }}"
                                                                                                                                            ...
                                                                                                                                            <ul class="sidenav-item-collapse">
                                                                                                                                                @if(!$authUser->isUser())
                                                                                                                                                    <li
                                                                                                                                                        class="mmt-5 {{ (request()->is('panel/marketing/special_offers')) ? 'active' : '' }}">
                                                                                                                                                        <a
                                                                                                                                                            href="/panel/marketing/special_offers">{{ trans('panel.discounts') }}</a>
                                                                                                                                                    </li>
                                                                                                                                                    <li
                                                                                                                                                        class="mmt-5 {{ (request()->is('panel/marketing/promotions')) ? 'active' : '' }}">
                                                                                                                                                        <a
                                                                                                                                                            href="/panel/marketing/promotions">{{ trans('panel.promotions') }}</a>
                                                                                                                                                    </li>
                                                                                                                                                @endif

                                                                                                                                                @if(!empty($referralSettings) and $referralSettings['status'] and $authUser->affiliate)
                                                                                                                                                    <li
                                                                                                                                                        class="mmt-5 {{ (request()->is('panel/marketing/affiliates')) ? 'active' : '' }}">
                                                                                                                                                        <a
                                                                                                                                                            href="/panel/marketing/affiliates">{{ trans('panel.affiliates') }}</a>
                                                                                                                                                    </li>
                                                                                                                                                @endif

                                                                                                                                                @if(!empty(getRegistrationBonusSettings('status')) and $authUser->enable_registration_bonus)
                                                                                                                                                    <li
                                                                                                                                                        class="mmt-5 {{ (request()->is('panel/marketing/registration_bonus')) ? 'active' : '' }}">
                                                                                                                                                        <a
                                                                                                                                ...
                                                                                                                                @if(getFeaturesSettings('forums_status'))
                                                                                                                                    <li
                                                                                                                                        class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/forums') or request()->is('panel/forums/*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                        <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                        ...
                                                                                                                                        <div class="collapse {{ (request()->is('panel/forums') or request()->is('panel/forums/*')) ? 'show' : '' }}"
                                                                                                                                            ...
                                                                                                                                            <ul class="sidenav-item-collapse">
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('/forums/create-topic')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/forums/create-topic">{{ trans('update.new_topic') }}</a>
                                                                                                                                                </li>
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/forums/topics')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/forums/topics">{{ trans('update.my_topics') }}</a>
                                                                                                                                                </li>

                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/forums/posts')) ? 'active' : '' }}">
                                                                                                                                                    <a href="/panel/forums/posts">{{ trans('update.my_posts') }}</a>
                                                                                                                                                </li>

                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/forums/bookmarks')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/forums/bookmarks">{{ trans('update.bookmarks') }}</a>
                                                                                                                                                </li>
                                                                                                                                            </ul>
                                                                                                                                        </div>
                                                                                                                                    </li>
                                                                                                                                ...
                                                                                                                                @if($authUser->isTeacher())
                                                                                                                                    <li
                                                                                                                                        class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/blog') or request()->is('panel/blog/*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                        <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                            ...
                                                                                                                                            <span>{{ trans('update.articles') }}</span>
                                                                                                                                            <button class="btn btn-toggle align-items-center rounded collapsed" id="mainbtn"
                                                                                                                                            data-bs-toggle="collapse" data-bs-target="#home-collapse-child-5592"
                                                                                                                                            aria-expanded="false">
                                                                                                                                            <svg class="svg-inline--fa fa-caret-down fa-w-10" aria-hidden="true"
                                                                                                                                        ...
                                                                                                                                        <div class="collapse {{ (request()->is('panel/blog') or request()->is('panel/blog/*')) ? 'show' : '' }}"
                                                                                                                                            ...
                                                                                                                                            <ul class="sidenav-item-collapse">
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/blog/posts/new')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/blog/posts/new">{{ trans('update.new_article') }}</a>
                                                                                                                                                </li>

                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/blog/posts')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/blog/posts">{{ trans('update.my_articles') }}</a>
                                                                                                                                                </li>

                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/blog/comments')) ? 'active' : '' }}">
                                                                                                                                ...
                                                                                                                                @if($authUser->isOrganization() || $authUser->isTeacher())
                                                                                                                                    <li
                                                                                                                                        class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/noticeboard*') or request()->is('panel/course-noticeboard*')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                        <a class="d-flex align-items-center" data-toggle="collapse"
                                                                                                                                            ...
                                                                                                                                            <span>{{ trans('panel.noticeboard') }}</span>
                                                                                                                                            <button class="btn btn-toggle align-items-center rounded collapsed" id="mainbtn"
                                                                                                                                            data-bs-toggle="collapse" data-bs-target="#home-collapse-child-5592"
                                                                                                                                            aria-expanded="false">
                                                                                                                                            <svg class="svg-inline--fa fa-caret-down fa-w-10" aria-hidden="true"
                                                                                                                                        ...
                                                                                                                                        <div class="collapse {{ (request()->is('panel/noticeboard*') or request()->is('panel/course-noticeboard*')) ? 'show' : '' }}"
                                                                                                                                            ...
                                                                                                                                            <ul class="sidenav-item-collapse">
                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/noticeboard')) ? 'active' : '' }}">
                                                                                                                                                    <a href="/panel/noticeboard">{{ trans('public.history') }}</a>
                                                                                                                                                </li>

                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/noticeboard/new')) ? 'active' : '' }}">
                                                                                                                                                    <a href="/panel/noticeboard/new">{{ trans('public.new') }}</a>
                                                                                                                                                </li>

                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/course-noticeboard')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/course-noticeboard">{{ trans('update.course_notices') }}</a>
                                                                                                                                                </li>

                                                                                                                                                <li
                                                                                                                                                    class="mmt-5 {{ (request()->is('panel/course-noticeboard/new')) ? 'active' : '' }}">
                                                                                                                                                    <a
                                                                                                                                                        href="/panel/course-noticeboard/new">{{ trans('update.new_course_notices') }}</a>
                                                                                                                                                </li>
                                                                                                                                            </ul>
                                                                                                                                        </div>
                                                                                                                                    </li>
                                                                                                                                ...
                                                                                                                                @if(!empty($rewardSetting) and $rewardSetting['status'] == '1')
                                                                                                                                    <li
                                                                                                                                        class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/rewards')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                ...
                                                                                                                                @if($authUser->checkAccessToAIContentFeature())
                                                                                                                                    <li
                                                                                                                                        class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/ai-contents')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                ...
                                                                                                                                <li
                                                                                                                                    class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/notifications')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                    <a href="/panel/notifications" class="d-flex align-items-center">
                                                                                                                                        ...
                                                                                                                                        <span>{{ trans('panel.notifications') }}</span>
                                                                                                                                    </a>
                                                                                                                                </li>

                                                                                                                                <li
                                                                                                                                    class="q-item q-item-type row no-wrap q-item--clickable q-link cursor-pointer q-focusable q-hoverable {{ (request()->is('panel/setting')) ? 'sidenav-item-active' : '' }}">
                                                                                                                                    <a href="/panel/setting" class="d-flex align-items-center">
                                                                                                                                        ...
                                                                                                                                        <span>{{ trans('panel.settings') }}</span>
                                                                                                                                    </a>
                                                                                                                                </li>
                                                                                                                                ...
                                                                                                                                @if($authUser->isTeacher() or $authUser->isOrganization())
                                                                                                                                    <li
                                                                                                                                        ...
                                                                                                                                        <a href="{{ $authUser->getProfileUrl() }}"
                                                                                                                                            ...
                                                                                                                                            <span>{{ trans('public.my_profile') }}</span>
                                                                ...
                                                                <div class="q-avatar text-black q-chip--colored">
                                                                    <div class="q-avatar__content row flex-center overflow-hidden">
                                                                        @if ($sidebar[$i]['child'][$j]['custom'] == 1)
                                                                            {!! $sidebar[$i]['icon'] !!}
                                                                        @else
                                                                            <i class="q-icon {{ $sidebar[$i]['child'][$j]['icon'] }}"></i>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="q-item__section column q-item__section--main justify-center">
                                                                <Span class="sidechild"> {{ $sidebar[$i]['child'][$j]['label'] }}
                                                                </Span>
                                                            </div>
                                                        </a>
                        ...
                        {{-- @if (isset($sidebarPart2))
                            @for ($i = 0; $i < count($sidebarPart2); $i++)
                                <div class="q-item q-item-type row no-wrap " style="--bs-gutter-x: 0.5rem;" role="listitem">
                                    <div
                                        class="q-item__section column q-item__section--main justify-center bg-[#FFC50B] py-[5px] px-[10px] rounded-md d-flex flex-row justify-between">
                                        <div style="display: flex; flex-direction: column; justify-content: center;">
                                            <div class="q-item__label text-[18px] font-semibold">
                                                {{ $sidebarPart2[$i]['label'] }}
