...
Route::get('/country/{code}', [UserController::class, 'changeCountry'])->name('country.change');
...
// $servername = "allsites.adorasystem.com";
// $username = "kemecademy_dbv1";
// $password = "xf*_4qdo@Ex5";
// $database = "kemecademy_dbv1";

// $conn = new mysqli($servername, $username, $password, $database);

// if ($conn) {
//     die("CONECTED : " . "SERVER_NAME " .$servername . " DB: " .$database  . " User_name : " .$username);
// }else{
// echo "NOT CONNECTED!";
// $conn->close();
// }
...
// Route::get('/locale/{ln}', function ($ln) {
...
//     // //$lang = Session::get('site_language');
//     return redirect()->back();
// })->name('locale');

Route::get('/locale/{ln}', [LocaleController::class, 'setCommonLocale'])->name('locale');
